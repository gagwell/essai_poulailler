...
from MagicQuill.debug_utils import print_debug_info  # IMPORT EN HAUT DU FICHIER
import re
...
class LLaVAModel:
    def __init__(self):
        ...
        model_path = os.path.join(current_dir, "models", "llava-v1.5-7b-finetune-clean")
         # Appel du debug juste avant de charger le modèle
        print_debug_info()  # Affiche les infos GPU avant de charger le modèle
